    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .epic-card:hover { border-color: #2A5080; }
        .feature-row {
          display: flex;
          align-items: center;
          gap: 12px;
        ...
        .feature-row:hover { background: #0F2035; padding-left: 6px; padding-right: 6px; margin: 0 -6px; }
        .global-bar-track {
          background: #0F2035;
          border-radius: 999px;
          height: 8px;
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div className="global-bar-track">
            <div style={{
              height: "100%",
              width: `${globalPct}%`,
              background: "linear-gradient(90deg, #4AB8D8, #F5A623)",
              borderRadius: 999,
          ...
          <span style={{ fontSize: 11, color: "#2A4A6A" }}>{doneSteps}/{totalSteps} stappen</span>
        </div>
      </div>
      ...
      <div style={{
        ...
        {stepLabels.map((label, i) => (
          <div key={i} style={{
            ...
            background: "#112038", border: "1px solid #1E3A5A",
        ...
        return (
          <div key={epic} className="epic-card" style={{ borderColor: `${color.accent}22` }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, paddingBottom: 8, borderBottom: `1px solid ${color.dim}`, marginBottom: 4 }}>
              <span style={{ fontSize: 9, color: "#2A4A6A", width: 130, letterSpacing: "0.08em" }}>FEATURE</span>
              <div style={{ display: "flex", alignItems: "center", gap: 4, flex: 1 }}>
                {stepLabels.map((label, i) => (
                  <div key={i} style={{ width: 32, textAlign: "center", fontSize: 8, color: "#2A4A6A", letterSpacing: "0.04em" }}>
                    {i + 1}
                  </div>
                ))}
              </div>
              <span style={{ fontSize: 9, color: "#2A4A6A", width: 40, textAlign: "right", letterSpacing: "0.08em" }}>DONE</span>
            </div>
            ...
            {features.map((feature) => {
              ...
              return (
                <div key={feature.id} className="feature-row">
                  {/* Feature name */}
                  <div style={{
                    width: 130, fontSize: 11, color: allDone ? color.accent : "#5A7A9A",
                  ...
                  <div style={{
                    ...
                    fontFamily: "'Syne', sans-serif",
                    fontWeight: 700,
                    color: allDone ? color.accent : done > 0 ? "#4A6A8A" : "#1E3A5A",
                  }}>
                    {pct}%
                  </div>
                </div>
      ...
      <div style={{ textAlign: "center", fontSize: 10, color: "#1E3A5A", marginTop: 12, letterSpacing: "0.08em" }}>
