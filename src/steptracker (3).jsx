    ...
    <div style={{
      ...
      <div style={{ marginBottom: 36 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <span style={{ fontFamily: "'Syne', sans-serif", fontSize: 13, fontWeight: 700, color: "#1B2F5E", minWidth: 36 }}>
            {globalPct}%
          </span>
          <span style={{ fontSize: 11, color: "#9AAEC8" }}>{doneSteps}/{totalSteps} stappen</span>
        </div>
      </div>
